...
error_code sys_storage_open(u64 device, u64 mode, vm::ptr<u32> fd, u64 flags)
{
	...
	{
		file = fs::file("F:/Users/clienthax/Downloads/extnorarea.dat", fs::read);//TODO
		if (!file)
		{
...
error_code sys_storage_get_device_info(u64 device, vm::ptr<StorageDeviceInfo> buffer)
{
	...
	else if (storage == NAND_FLASH)
	{
		...
		switch (dev_num)
		{
		case 0: buffer->sector_count = 0x80000; break;
		case 1: buffer->sector_count = 0x75F8; break;
		case 2: buffer->sector_count = 0x63E00; break;
		case 3: buffer->sector_count = 0x8000; break;
		case 4: buffer->sector_count = 0x400; break;
		case 5: buffer->sector_count = 0x2000; break;
		case 6: buffer->sector_count = 0x200; break;
		}
	}
	else if (storage == NOR_FLASH)
	{
		...
		switch (dev_num)
		{
		case 0: buffer->sector_count = 0x8000; break;
		case 1: buffer->sector_count = 0x77F8; break;
		case 2:
			buffer->sector_count = 0x100; // offset, 0x20000
			break;
		case 3: buffer->sector_count = 0x400; break;
		}
	}
	else if (storage == NAND_UNK)
	{
		...
		switch (dev_num)
		{
		case 0: buffer->sector_count = 0x7FFFFFFF; break;
		}
	}
	else
	{
