...
u32 _sys_heap_create_heap(vm::cptr<char> name, u32 size, u32 arg3, u32 arg4)
{
	sysPrxForUser.warning("_sys_heap_create_heap(name=%s, size=0x%x, arg3=0x%x, arg4=0x%x)", name, size, arg3, arg4);
