...
vm::ptr<CellGcmReportData> cellGcmGetReportDataAddressLocation(u32 index, u32 location)
{
	...
	if (location == CELL_GCM_LOCATION_LOCAL) {
		...
		return vm::ptr<CellGcmReportData>::make(rsx_ctxaddr + 0x301400 + index * 0x10);
	}
...
u64 cellGcmGetTimeStamp(u32 index)
{
	...
	return vm::read64(rsx_ctxaddr + 0x301400 + index * 0x10);
}
...
{
	return vm::ptr<CellGcmReportData>::make(rsx_ctxaddr + 0x301400); // TODO
}
...
u32 cellGcmGetReportDataAddress(u32 index)
{
	...
	return rsx_ctxaddr + 0x301400 + index * 0x10;
}
